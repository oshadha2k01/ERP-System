                ...
                <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="title" required>
                            ...
                            <option value="Mrs" <?php echo ($customer['title'] == 'Mrs') ? 'selected' : ''; ?>>Mrs
                            </option>
                            <option value="Miss" <?php echo ($customer['title'] == 'Miss') ? 'selected' : ''; ?>>Miss
                            </option>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="district" required>
                            ...
                            <?php foreach ($districts as $districtOption): ?>
                                <option value="<?php echo $districtOption['id']; ?>" <?php echo ($districtOption['id'] == $customer['district']) ? 'selected' : ''; ?>>
                                    <?php echo $districtOption['district']; ?>
                                </option>
                            <?php endforeach; ?>
                        </select>
                    </div>
